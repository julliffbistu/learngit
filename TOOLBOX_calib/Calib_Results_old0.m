...
%-- Focal length:
fc = [ 657.849557728869510 ; 658.391549432053350 ];

%-- Principal point:
cc = [ 302.626826366157220 ; 244.557212309731970 ];

%-- Skew coefficient:
alpha_c = 0.000000000000000;

%-- Distortion coefficients:
kc = [ -0.260884766192579 ; 0.155839768637361 ; 0.000044947296372 ; -0.000077840213352 ; 0.000000000000000 ];

%-- Focal length uncertainty:
fc_error = [ 0.507080009080902 ; 0.584365340318322 ];

%-- Principal point uncertainty:
cc_error = [ 1.152169809356033 ; 1.007974122378399 ];

%-- Skew coefficient uncertainty:
alpha_c_error = 0.000000000000000;

%-- Distortion coefficients uncertainty:
kc_error = [ 0.004606116508035 ; 0.021585468517948 ; 0.000225775490269 ; 0.000241551562498 ; 0.000000000000000 ];
